...
<img src="/image/play.PNG" width="80%">
...
<img src="/image/gcloud.png"> <br>

1년간 무료로 사용할 수 있는 크레딧을 주기때문에 공부삼아 해보기 딱 좋다 <br>


<img src="/image/function.png" width="95%"><br>

빨간 화살표가 있는 곳은 클릭을 해서 들어가면 된다

<img src="/image/function_01.png" width="33%"><img src="/image/function_02.png" width="33%"><img src="/image/function_03.png" width="33%"><br>

사진 순서대로 따라오면 직접 만든 nugu play kit 에 맞는 백엔드서버도 만들어진다
만든 후에는 nugu play builder로 이동해서 외부연동서버 주소에 URL을 넣어줘야한다<br><br>

<img src="/image/backend_add.png" width="75%"><br>
...
<img src="https://postfiles.pstatic.net/MjAxOTA5MDdfMjIz/MDAxNTY3ODU3ODAzMjA3.3YjmaaoB-eAL09gEqCrL2Rt9C-96j853vMyu1zMHJXAg.Nl4W01JGY-HKwc9xDxy_Ivu5I5BJlqAx19z_F7AC7Kcg.PNG.sjszzang0929/image.png?type=w966" width="75%">
...
<imt src="/image/intent 만들기" width="90%"><br><br>
직접 만든 play => Intents => intent 추가를 한다
...
> action 만들기
<img scr="/image/action이동.gif" width="90%"><br><br>
