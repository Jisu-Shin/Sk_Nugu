...
먼저  [NUGU developers](https://developers.nugu.co.kr/#/) 에서 회원가입을 한다음<ㅠㄱ>
<br>
<img src="/image/playbuilder.png" width="80%"><br>
<br>

developer 사이트에서 사진과 같은 방법으로 play builder에 넘어오면 된다<br>
<br>
<img src="/image/play.PNG" width="80%"><br>
...
처음으로 [구글클라우드](https://cloud.google.com/functions/) 를 들어가게 되면 뜨는 화면이다 <br><br>
...
<img src="/image/function_01.png" width="33%"><img src="/image/function_02.png" width="33%"><img src="/image/function_03.png" width="33%"><br><br>

사진 순서대로 따라오면 직접 만든 nugu play kit 에 맞는 백엔드서버도 만들어진다
만든 후에는 nugu play builder로 이동해서 외부연동서버 주소에 URL을 넣어줘야한다<br><br>

<p align="center">
<img src="/image/backend_add.png" width="60%"><br>
</p>
